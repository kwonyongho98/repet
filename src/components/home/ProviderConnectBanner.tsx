...
export default function ProviderConnectBanner({ variant = 'default' }: ProviderConnectBannerProps) {
  ...
  if (variant === 'compact') {
    return (
      <Link
        to="/home/provider-connect"
        className="flex items-center gap-3 mx-4 mb-4 p-4 bg-gradient-to-r from-orange-50 to-pink-50 dark:from-orange-900/20 dark:to-pink-900/20 rounded-2xl border border-orange-100 dark:border-orange-800/30"
      >
